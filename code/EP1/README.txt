...
Os aquivos desta entrega estão na pasta /code/EP1.
São eles:
    * FileOp.py  -- Arquivo principal da entrega. Contém a construção dos menus, operações de leitura e escrita dos arquivos. Também aqui há as funções de soma e multiplicação.
